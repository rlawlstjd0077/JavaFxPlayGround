package com.jinseong.soft.tray;
    ...
    public void addAppToTray() {
        try {
            if (!SystemTray.isSupported()) {
                System.out.println("Failed to display com.jinseong.soft.tray icon - no system com.jinseong.soft.tray support");
                return;
            }
            ...
            System.out.println("Failed to display com.jinseong.soft.tray icon");
        }
    }
